...
const Archievements = ({ amount, title, children }) => {
    ...
    return (
        <div className="flex items-end gap-x-3">
            ...
            <h1 className="flex flex-col gap-y-2"><motion.span className="text-2xl lg:text-xl font-light text-yellow-500  " whileInView={()=>count(amount)} viewport={{once:true}}>{number}</motion.span>
