    ...
    return (
        <motion.li
            ...
            <h1
                ...
                className={` text-gray-800 hover:text-yellow-600 flex items-center  text-xl font-extralight  tracking-wide cursor-pointer dark:text-white dark:hover:bg-zinc-700 dark:hover:text-yellow-600  ${show && "border-b text-yellow-600 "
                    }`}
            >
