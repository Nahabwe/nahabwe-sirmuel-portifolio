...
const Project = ({ data, index }) => {
    ...
    return (
        <motion.div
            ...
            <Image src={data.url} alt='Project Image' width={400} height={400} className='opacity-70 cursor-pointer rounded-lg' />
            ...
            <motion.div
                ...
                <p className='text-justify dark:text-gray-100 transition-colors'>{data.desc}</p>
            </motion.div>
        </motion.div>
    )
}
